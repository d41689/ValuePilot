...
const ANNUAL_FINANCIAL_ROW_LABELS = {
  ...
  'is.premiums_earned': 'P/C Premiums Earned ($M)',
  'is.loss_ratio': 'Loss / Prem Earned %',
  'is.expense_ratio': 'Exp / Prem Written %',
  'is.underwriting_margin': 'Underwriting Margin %',
  'is.inv_income_yield': 'Inv Inc / Total Inv %',
...
function annualFinancialMetricKey(groupKey, seriesKey) {
  const maps = {
    ...
    income_statement_usd_millions: {
      ...
      pc_premiums_earned: 'is.premiums_earned',
      loss_to_prem_earned_pct: 'is.loss_ratio',
      expense_to_prem_written: 'is.expense_ratio',
      underwriting_margin_pct: 'is.underwriting_margin',
      inv_inc_to_total_investments_pct: 'is.inv_income_yield',

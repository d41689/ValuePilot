...
CREATE TABLE raw_source_documents (
    ...
    document_type       VARCHAR(40) NOT NULL,         -- 取值必须受代码枚举约束：submissions_json / form_idx / filing_directory / primary_doc_xml / infotable_xml / dataroma_managers_html / dataroma_holdings_html
    cik                 VARCHAR(10),

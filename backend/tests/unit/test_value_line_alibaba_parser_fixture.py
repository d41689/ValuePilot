...
FIXTURE_PDF = Path("tests/fixtures/value_line/alibaba.pdf")
EXPECTED_JSON = Path("tests/fixtures/value_line/alibaba_v1.expected.json")
...
def test_value_line_alibaba_page_json_matches_expected_fixture():

...
FIXTURE_PDF = Path("tests/fixtures/value_line/coco.pdf")
EXPECTED_JSON = Path("tests/fixtures/value_line/coco_v1.expected.json")
...
def test_value_line_coco_page_json_matches_expected_fixture():

...
FIXTURE_PDF = Path("tests/fixtures/value_line/lrn.pdf")
EXPECTED_JSON = Path("tests/fixtures/value_line/lrn_v1.expected.json")
...
def test_value_line_lrn_page_json_matches_expected_fixture():

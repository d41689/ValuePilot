...
def test_lookup_stock_by_ticker_returns_summary(client, db_session):
    ...
    assert payload["dcf_inputs"] == {
        "net_profit_per_share": {"value": 4.8, "source": "fact"},
        "depreciation_per_share": {"value": 0.9, "source": "computed"},
        "capital_spending_per_share": {"value": 0.6, "source": "fact"},
    }
    assert payload["dcf_inputs_series"] == [
        {
            "year": 2026,
            "net_profit_per_share": {"value": 5.0, "source": "fact"},
            "depreciation_per_share": {"value": 1.0, "source": "computed"},
            "capital_spending_per_share": {"value": 0.5, "source": "fact"},
        },
        {
            "year": 2025,
            "net_profit_per_share": {"value": 4.9, "source": "fact"},
            "depreciation_per_share": {"value": 1.0, "source": "computed"},
            "capital_spending_per_share": {"value": 0.6, "source": "fact"},
        },
        {
        ...
        {
            "year": 2023,
            "net_profit_per_share": {"value": 4.7, "source": "fact"},
            "depreciation_per_share": {"value": 0.8, "source": "computed"},
            "capital_spending_per_share": {"value": 0.6, "source": "fact"},
        },
        {
            "year": 2022,
            "net_profit_per_share": {"value": 4.6, "source": "fact"},
            "depreciation_per_share": {"value": 0.7, "source": "computed"},
            "capital_spending_per_share": {"value": 0.6, "source": "fact"},
        },
        {
            "year": 2021,
            "net_profit_per_share": {"value": 4.5, "source": "fact"},
            "depreciation_per_share": {"value": 0.7, "source": "computed"},
            "capital_spending_per_share": {"value": 0.7, "source": "fact"},
        },
    ]

...
FIXTURE_PDF = Path("tests/fixtures/value_line/bti.pdf")
EXPECTED_JSON = Path("tests/fixtures/value_line/bti_v1.expected.json")
...
def test_value_line_bti_page_json_matches_expected_fixture():
